...
#if !defined(CY8C4146LQI_S422)
#error "Unexpected MPN; expected DEVICE:=CY8C4146LQI-S422. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(CY8C4146LQI_S422) */
